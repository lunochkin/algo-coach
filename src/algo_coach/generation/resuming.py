...
digest is no longer what the bench would send.
...
def moved_at(draft: Draft, bench: Bench = BENCH) -> WritingState | None:
    """The first step to re-run, or `None` where the bench answers this draft
    as it stands.
